...
export interface ProcessAppCategory {
  category: string
  apps: ProcessApp[]
}

export const COMMON_PROCESS_APPS: ProcessAppCategory[] = [
  {
    category: '下载工具',
    apps: [
...
export const COMMON_DOMAIN_SITES: string[] = [
  'openai.com',
  'google.com',
  'youtube.com',
  'github.com',
...
export function processNameFor(app: ProcessApp, platform = 'linux'): string {
  if (platform === 'windows') {
