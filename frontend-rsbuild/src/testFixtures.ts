...
import type {
  NodeInfo, RuleInfo, ScheduledRefreshStatus, StatusData, SubNodeInfo, SubNodesInfo, SubStatus,
} from './types/api'
...
export function scheduledRefreshStatusMock(
  overrides: Partial<ScheduledRefreshStatus> = {},
